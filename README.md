This file is the baseline code for NFL Health & Safety - Helmet Assignment--Segment and label helmets in video footage

以上文件是NFL Health & Safety - Helmet Assignment-Segment and label helmets in video footage（NFL 健康与安全 - 头盔分配）比赛的baseline代码
